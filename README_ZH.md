...
- 灵感来自复利增长原理
- 架构设计参考 [Compound Engineering Plugin](https://github.com/EveryInc/compound-engineering-plugin)
- 记忆系统设计参考 [ClawIntelligentMemory](https://github.com/denda188/ClawIntelligentMemory)
- OpenClaw 社区贡献者的支持
